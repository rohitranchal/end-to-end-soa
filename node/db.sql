...
(9, 'localhost:4109', 'S1', 10.0, 'localhost', 4109, 'http://localhost:4109', '{}', -1, 'scenarios/3/s9'),
(10, 'localhost:4110', 'S2', 10.0, 'localhost', 4110, 'http://localhost:4110', '{}', -1, 'scenarios/3/s10'),
(11, 'localhost:4111', 'S3', 10.0, 'localhost', 4111, 'http://localhost:4111', '{}', -1, 'scenarios/3/s11'),
(12, 'localhost:4112', 'S4', 10.0, 'localhost', 4112, 'http://localhost:4112', '{}', -1, 'scenarios/3/s12'),
(13, 'localhost:4113', 'S5', 10.0, 'localhost', 4113, 'http://localhost:4113', '{}', -1, 'scenarios/3/s13'),
(14, 'localhost:4114', 'S6', 10.0, 'localhost', 4114, 'http://localhost:4114', '{}', -1, 'scenarios/3/s14'),
(15, 'localhost:4115', 'S7', 10.0, 'localhost', 4115, 'http://localhost:4115', '{}', -1, 'scenarios/3/s15'),
